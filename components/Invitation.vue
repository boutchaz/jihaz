<i18n>
{
  ...
  "ar": {
    ...
    "customessage":"عائلة محمدبوتشمير و عائلة امحمد داري تتشرفان بدعوة جنابكم الكريم، لحضور حفل زفاف إبنيهما الآنسة المصونة جهان داري بالشاب  الأديب زكرياء بوتشمير أصلحهما الله و ذلك بمشيئة الله،يوم السبت 23 مارس 2022 إبتداأ من الساعة الثامنة مساء",
    "date": "التاريخ",
    "location": "المكان",
