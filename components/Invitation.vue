<i18n>
{
  ...
  "ar": {
    ...
    "customessage":"عائلة محمدبوتشمير و عائلة امحمد دري تتشرفان بدعوة جنابكم الكريم، لحضور حفل زفاف إبنيهما الآنسة المصونة جيهان دري بالشاب  الأديب زكرياء بوتشمير أصلحهما الله و ذلك بمشيئة الله،يوم السبت 23 مارس 2022 إبتداءا من الساعة الثامنة مساء",
    "date": "التاريخ",
    "location": "المكان",
