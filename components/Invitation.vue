<i18n>
{
  ...
  "ar": {
    ...
    "customessage":"عائلة محمدبوتشمير و عائلة محمد داري تتشرفان بدعوة جنابكم الكريم، لحضور حفل زفاف إبنيهما الآنسة المصونة جهان داري بالشاب  الأديب زكرياء بوتشمير أصلحهما الله و ذلك بمشيئة الله،يوم السبت 23 مارس 2202 إبتداءا من الساعة الثامنة مساء",
    "date": "التاريخ",
    "location": "المكان",
    "place": "دار المرجان",
    "input":"متمنياتكم",
