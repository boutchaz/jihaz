<i18n>
{
  ...
  "ar": {
    ...
    "customessage":"عائلة محمدبوتشمير و نعيمة الطلوحي تتشرفان بدعوة جنابكم الكريم، لحضور حفل زفاف إبنهما  الأديب زكرياء بوتشمير أصلحه الله و ذلك بمشيئة الله،يوم السبت 23 مارس 2202 إبتداء ا من الساعة الثامنة مساء",
    "date": "التاريخ",
    "location": "المكان",
    "place": "دار المرجان",
    "input":"متمنياتكم",
